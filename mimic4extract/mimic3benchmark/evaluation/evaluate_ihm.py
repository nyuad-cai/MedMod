...
def main():
    """Main function to evaluate predictions and compute metrics for in-hospital mortality."""
    # Set up command-line argument parsing
    parser = argparse.ArgumentParser()
    parser.add_argument('prediction', type=str, 
                        help='Path to the CSV file containing the predictions.')
    parser.add_argument('--test_listfile', type=str,
                        default=os.path.join(os.path.dirname(__file__), '../../data/in-hospital-mortality/test/listfile.csv'),
    ...
    # Merge prediction data with test data on 'stay'
